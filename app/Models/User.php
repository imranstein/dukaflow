...
class User extends Authenticatable implements FilamentUser
{
    ...
    /**
     * Reps can open the back office but see it read-only; what they can do
     * once inside is decided by App\Policies\BackOfficePolicy.
     */
    public function canAccessPanel(Panel $panel): bool
    {
        return $this->role->canReadBackOffice();
    }
